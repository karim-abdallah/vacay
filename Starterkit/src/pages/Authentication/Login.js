...
class Login extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { email: "aliasgher@gmail.com", password: "123456789", showPassword: true }
                                                ...
                                                <form onSubmit={this.handleSubmit}>
                                                    <Row className="my-5">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className=" mt-3 forget">Foget my Account</p>
...
//     const handleShowPassword1Toggle = () => {
...
//                 localStorage.setItem('token', post.jwt)
...
//                                                                 placeholder="Password"
//                                                             />
//                                                             <div onClick={handleShowPassword1Toggle}>
//                                                                 {showPassword ? (
//                                                                     <div >
//                                                                         <svg
//                                                                             xmlns="http://www.w3.org/2000/svg"
